...
def wish_list(wishList, desiredItem, cost = 0.0, budget = 0.0):
    if (desiredItem in wishList) and (cost <= budget):
        return "You should buy a " + desiredItem + "!"
    elif (desiredItem in wishList) and (cost >= budget):
        return "You should save up for a " + desiredItem + "!"
    elif (desiredItem not in wishList):
        return "You probably don't want to buy a " + desiredItem + "."
