...
#Add your code here!
def students_present(inputDictionary):
    presentStudentList = []
    for (studentName, attendance) in inputDictionary.items():
        if attendance == "Present" or attendance == "Here":
            presentStudentList.append(studentName)
